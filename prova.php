...
if(isset($_GET['genere'])) {
    ...
    try {
        ...
        if($connectionOk) {
            $resultGeneri = $connection -> getListaGeneriMigliori();
            foreach($resultGeneri as $genere) {
                $listaLibri.='
                <ul class="lista genere">';
                $risultatiLibri = $connection ->getListaLibriGenere($genere["genere"]);
            ...
            /*$risultatiLibri1 = $connection ->getListaLibriGenere();
            $risultatiLibri2 = $connection ->getListaLibriGenere($genere);
            $risultatiLibri3 = $connection ->getListaLibriGenere($genere);
            $risultatiLibri4 = $connection ->getListaLibriGenere($genere);
            $risultatiLibri5 = $connection ->getListaLibriGenere($genere);*/
